import { syntaxTree, indentNodeProp, foldNodeProp, continuedIndent, LRLanguage, LanguageSupport } from '/_m/__/language/dist/index.js';
import { styleTags, tags } from '/_m/__/node_modules/@lezer/highlight/dist/index.js';
import { ExternalTokenizer, LRParser } from '/_m/__/node_modules/@lezer/lr/dist/index.js';
import { ifNotIn, completeFromList } from '/_m/__/autocomplete/dist/index.js';
...
function maybeQuoteCompletions(openingQuote, closingQuote, completions) {
    return completions.map(c => (Object.assign(Object.assign({}, c), { label: c.label[0] == openingQuote ? c.label : openingQuote + c.label + closingQuote, apply: undefined })));
}
