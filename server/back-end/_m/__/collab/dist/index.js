const { Facet, combineConfig, Annotation, StateField, StateEffect, ChangeSet, Transaction } = require('../../state/dist/index.js');
...
module.exports = { collab, getClientID, getSyncedVersion, rebaseUpdates, receiveUpdates, sendableUpdates };
